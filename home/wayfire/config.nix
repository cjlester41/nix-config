...
{  
  wayland.windowManager.wayfire.settings = {
    ...
    autostart = {
      autostart0 = "~/./glpaper/build/glpaper -F HDMI-A-1 ~/nix-config/test.glsl"; #"waypaper --restore"; # "./GLWall/GLWall /home/cjlester/GLWall/rain.glsl /home/cjlester/Pictures/forest2.jpg";
    ...
    cube = {
      ...
      cubemap_image = "/home/cjlester/Downloads/cubemap.png";
      deform = 0;
